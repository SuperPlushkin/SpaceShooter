...
public abstract class Enemy implements IHaveSize {
    ...
    private static final String[] STAR_WARS_NAMES = {
        "Люк Скайуокер", "Лея", "Хан Соло", "Чубакка", "Лэндо",
        "Оби-Ван Кеноби", "Магистр Йода", "Мон Мотма", "Алах Акбар", "Ведж",
        "Энакин Скайуокер", "Падме", "Асока Тано", "Кейнан", "Гера Ин",
        "Сабин", "Зэб", "Кассиан", "Джин Эрсо", "Бейл Органа",
        "Квай-Гон", "Мейс Винду", "Пло Кун", "Эйла", "Ки-Ади-Мунди",
        "Шаак Ти", "Гален Эрсо", "Бо-Катан", "Эзра Бриджер", "Рей Скайуокер",
        "Финн", "По Дэмерон", "Роуз Тико", "Маз Каната", "Джанна", "Грогу (В соло)",
        "Ниен Нунб", "Гарвен Дрейс", "Биггс", "Боба Фетт", "Дин Джарин", "Дарт Не Вейдер"
    };
